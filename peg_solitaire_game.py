...
def create_board(boardType) -> List[List[str]]:
...
def main():
    ...
    print("  3) Triangle")
    print("  4) Simple T")
    print("Choose a board style: ", end="")

    # make sure boardStyle is legal
    boardStyle = input()
    while not boardStyle.isdigit() or not 1 <= int(boardStyle) <= 4:
        print("Please enter your choice as an integer between 1 and 4: ", end='')
        boardStyle = input()
    board = create_board(int(boardStyle)) 
